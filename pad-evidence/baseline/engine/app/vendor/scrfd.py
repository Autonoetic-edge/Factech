...
# https://github.com/deepinsight/insightface/blob/3e6486942a1be2da0e5b475fac375ea73264bd21/python-package/insightface/model_zoo/scrfd.py
...
def get_scrfd(name, download=False, root='~/.insightface/models', **kwargs):
    if not download:
        ...
        raise NotImplementedError(
            'model_store download removed in the vendored copy; '
            'use engine/scripts/download_models.py'
        )
